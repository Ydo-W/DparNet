...
if __name__ == '__main__':
    ...
    # Paths
    gt_video_dir = para.data_root + 'clean_seqs/'
    ...
    test_start_id = int(len(gt_videos) * 0.8) + 1
    for video_idx in range(test_start_id, len(gt_videos)+1):
        ...
        for frame_index in range(frame_length):
            ...
            if neighboring_frames <= frame_index < frame_length - neighboring_frames:
                ...
                video_SSIM = video_SSIM + computate_SSIM(frame1, frame2, data_range=255., channel_axis=2)
